        ...
        for row in pred.itertuples():
            ...
            for contour in contours:
                ...
                for corner in approx:
                    ...
                    point_mask[actual_y - SHORTEST_DISTANCE_BETWEEN_POINTS:actual_y + SHORTEST_DISTANCE_BETWEEN_POINTS, actual_x - SHORTEST_DISTANCE_BETWEEN_POINTS:actual_x + SHORTEST_DISTANCE_BETWEEN_POINTS] = 255
                    if output_path:
